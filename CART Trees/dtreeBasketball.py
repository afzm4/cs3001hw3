#   Edited by Andrew Floyd for different data
...
if __name__ == '__main__':
    ...
    if example == 1:
        ...
        bHeader = True
        # the bigger example
        dcHeadings, trainingData = loadCSV('basketball.csv') # demo data from matlab
        ...
        dot_data = dotgraph(decisionTree)
        graph = pydotplus.graph_from_dot_data(dot_data)
        #graph.write_pdf("basketballcart.pdf")
        #graph.write_png("basketballcart.png")
